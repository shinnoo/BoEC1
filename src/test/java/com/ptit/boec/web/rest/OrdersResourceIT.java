...
import com.ptit.boec.repository.OrdersRepository;
...
class OrdersResourceIT {
    ...
    public static Orders createEntity(EntityManager em) {
        Orders orders = new Orders().totalPrice(DEFAULT_TOTAL_PRICE).cartId(DEFAULT_CART_ID);
        return orders;
    }
    ...
    public static Orders createUpdatedEntity(EntityManager em) {
        Orders orders = new Orders().totalPrice(UPDATED_TOTAL_PRICE).cartId(UPDATED_CART_ID);
        return orders;
    }
    ...
    void createOrders() throws Exception {
        ...
        assertThat(testOrders.getCartId()).isEqualTo(DEFAULT_CART_ID);
    }
    ...
    void putNewOrders() throws Exception {
        ...
        updatedOrders.totalPrice(UPDATED_TOTAL_PRICE).cartId(UPDATED_CART_ID);
        ...
        assertThat(testOrders.getCartId()).isEqualTo(UPDATED_CART_ID);
    }
    ...
    void partialUpdateOrdersWithPatch() throws Exception {
        ...
        partialUpdatedOrders.cartId(UPDATED_CART_ID);
    ...
    void fullUpdateOrdersWithPatch() throws Exception {
        ...
        partialUpdatedOrders.totalPrice(UPDATED_TOTAL_PRICE).cartId(UPDATED_CART_ID);
