...
import com.ptit.boec.domain.Payment;
import com.ptit.boec.repository.PaymentRepository;
...
class PaymentResourceIT {
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment().createAt(DEFAULT_CREATE_AT).code(DEFAULT_CODE);
        return payment;
    }
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment().createAt(UPDATED_CREATE_AT).code(UPDATED_CODE);
        return payment;
    }
    ...
    void putNewPayment() throws Exception {
        ...
        updatedPayment.createAt(UPDATED_CREATE_AT).code(UPDATED_CODE);
    ...
    void fullUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.createAt(UPDATED_CREATE_AT).code(UPDATED_CODE);
