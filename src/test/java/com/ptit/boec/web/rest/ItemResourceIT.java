...
class ItemResourceIT {
    ...
    public static Item createEntity(EntityManager em) {
        Item item = new Item().name(DEFAULT_NAME).price(DEFAULT_PRICE).cartId(DEFAULT_CART_ID);
        return item;
    }
    ...
    public static Item createUpdatedEntity(EntityManager em) {
        Item item = new Item().name(UPDATED_NAME).price(UPDATED_PRICE).cartId(UPDATED_CART_ID);
        return item;
    }
    ...
    void putNewItem() throws Exception {
        ...
        updatedItem.name(UPDATED_NAME).price(UPDATED_PRICE).cartId(UPDATED_CART_ID);
    ...
    void fullUpdateItemWithPatch() throws Exception {
        ...
        partialUpdatedItem.name(UPDATED_NAME).price(UPDATED_PRICE).cartId(UPDATED_CART_ID);
